...
class HotelAdmin(admin.ModelAdmin):
    ...
    def mark_as_unverified(self, request, queryset):
        ...
        self.message_user(request, f"{updated} hotels successfully marked as unverified.")
...
class RoomAdmin(admin.ModelAdmin):
    list_display = ('title', 'hotel', 'room_type',  'price_per_night',
                    'capacity', 'is_available', 'rating', 'created_at')
